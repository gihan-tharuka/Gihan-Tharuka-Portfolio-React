...
const skills = [
  { id: "c", name: "C", type: "Language", level: 4, years: 4, color: "#A8A77A", icon: "code", order: 1 },
  { id: "csharp", name: "C#", type: "Language", level: 4, years: 3, color: "#239120", icon: "code", order: 2 },
  { id: "java", name: "Java", type: "Language", level: 5, years: 6, color: "#007396", icon: "code", order: 3 },
  { id: "javascript", name: "JavaScript", type: "Language", level: 5, years: 6, color: "#f7df1e", icon: "code", brandIcon: "js", order: 4 },
  { id: "php", name: "PHP", type: "Language", level: 4, years: 3, color: "#777bb4", icon: "code", brandIcon: "php", order: 5 },
  { id: "html", name: "HTML", type: "Language", level: 5, years: 7, color: "#e34f26", icon: "code", brandIcon: "html5", order: 6 },
  { id: "python", name: "Python", type: "Language", level: 4, years: 4, color: "#3776ab", icon: "code", brandIcon: "python", order: 7 },

  { id: "reactjs", name: "ReactJS", type: "Framework", level: 4, years: 5, color: "#61dafb", icon: "cubes", brandIcon: "react", order: 8 },
  { id: "flutter", name: "Flutter", type: "Framework", level: 3, years: 2, color: "#02569B", icon: "mobile", order: 9 },
  { id: "laravel", name: "Laravel", type: "Framework", level: 5, years: 2, color: "#FF2D20", icon: "feather", order: 10 },
  { id: "servlets", name: "Servlets", type: "Framework", level: 4, years: 3, color: "#6b7280", icon: "server", order: 11 },
  ...
  { id: "mssql", name: "Microsoft SQL Server", type: "Database", level: 4, years: 3, color: "#CC2927", icon: "database", order: 27 },
  { id: "sqlite", name: "SQLite", type: "Database", level: 4, years: 2, color: "#003b57", icon: "database", order: 28 },
  { id: "postgresql", name: "PostgreSQL", type: "Database", level: 5, years: 3, color: "#336791", icon: "database", order: 29 },

  { id: "selenium", name: "Selenium", type: "Tool", level: 3, years: 2, color: "#43B02A", icon: "wrench", order: 30 },
  { id: "googleanalytics", name: "Google Analytics", type: "Tool", level: 3, years: 2, color: "#E37400", icon: "wrench", order: 31 },
  { id: "github", name: "GitHub", type: "Tool", level: 5, years: 5, color: "#181717", icon: "wrench", order: 32 },
  { id: "junit", name: "JUnit", type: "Tool", level: 4, years: 3, color: "#25A18E", icon: "wrench", order: 33 },
  { id: "postman", name: "Postman", type: "Tool", level: 4, years: 2, color: "#FF6C37", icon: "wrench", order: 34 },
