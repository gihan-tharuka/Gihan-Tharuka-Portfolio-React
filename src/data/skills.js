...
const skills = [
  ...
  { id: "html", name: "HTML", type: "Markup", level: 5, years: 7, color: "#e34f26", icon: "code", brandIcon: "html5" },
  ...
  { id: "tailwind", name: "Tailwind", type: "Framework", level: 5, years: 3, color: "#38bdf8", icon: "cubes" },
  ...
  { id: "firebase", name: "Firebase", type: "Service", level: 3, years: 2, color: "#FFCA28", icon: "cloud" },
  { id: "postgresql", name: "PostgreSQL", type: "Database", level: 5, years: 3, color: "#336791", icon: "database" },

  { id: "s3", name: "S3", type: "Service", level: 4, years: 2, color: "#569a31", icon: "cloud" },
  { id: "dynamodb", name: "DynamoDB", type: "Service", level: 5, years: 1, color: "#4053D6", icon: "cloud" },
